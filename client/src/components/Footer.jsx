...
const Footer = () => {
  ...
  return (
    <footer className="mt-24 border-t border-[#2ff5a833] bg-[#1b2521] text-slate-50">
      <div className="mx-auto grid w-full max-w-360 grid-cols-1 gap-12 px-4 pb-12 pt-16 md:px-8 lg:grid-cols-4">
        {/* Brand Section */}
        <div className="flex flex-col lg:col-auto">
          <h3 className="mb-4 text-2xl font-bold text-white">TraceHub</h3>
          <p className="mb-6 max-w-md text-sm leading-7 text-slate-300">A secure platform for publishing and verifying academic resources with blockchain proof.</p>
        ...
        <div className="flex flex-col">
          <h4 className="mb-5 text-sm font-bold uppercase tracking-wide text-slate-100">Quick Links</h4>
        ...
        {/* Features */}
        <div className="flex flex-col">
          <h4 className="mb-5 text-sm font-bold uppercase tracking-wide text-slate-100">Features</h4>
          <ul className="space-y-3">
        ...
        {/* Contact */}
        <div className="flex flex-col">
          <h4 className="mb-5 text-sm font-bold uppercase tracking-wide text-slate-100">Contact</h4>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#2a3932] bg-[#16201c] px-4 py-8 text-center md:px-8">
        <p className="mb-4 text-sm text-slate-300">&copy; {currentYear} TraceHub. All rights reserved.</p>
